...
//        int manid = cmbManager.getSelectedIndex();
        String manid = cmbManager.getSelectedItem().toString();
        String[] getManagerId = manid.split(" - ");
//        int manidx = cmbManager.getSelectedIndex();
//        int locid = cmbLocation.getSelectedIndex();
        String locid = cmbLocation.getSelectedItem().toString();
        String[] getLocationId = locid.split(" - ");
        //        String locid = txtLocId.getText();
        //        String loco = Integer.toString(locid);
//        JOptionPane.showMessageDialog(this, getManagerId[0]);
//        JOptionPane.showMessageDialog(this, getLocationId[0]);
//        JOptionPane.showMessageDialog(this, getManagerId[0]);

//        int nilai = 0;
        String[] IdMan;
        int cekNull = cmbManager.getSelectedIndex();
//        JOptionPane.showMessageDialog(this, cekNull);
        if (cekNull == 0) {
////            JOptionPane.showMessageDialog(this, cekNull);
            getManagerId[0] = null;
            IdMan = getManagerId;
...
//            JOptionPane.showMessageDialog(this, getManagerId[1]);
            IdMan = getManagerId;
        }
//
        int a = departmentController.selectById(id).getId();
        if (Integer.parseInt(id) == a) {
            JOptionPane.showMessageDialog(this, departmentController.update(id, name, IdMan[0], getLocationId[0]));
        } else {
            JOptionPane.showMessageDialog(this, departmentController.create(id, name, IdMan[0], getLocationId[0]));
        }
        reset();
        bindingTabel();
...
//        cmbLocation.setSelectedItem((String) tblDepartment.getValueAt(row, 3).toString());
        ...
        cmbLocation.setSelectedItem(locationController.selectName(s).getId() + " - " + s);

//        txtManId.setText((String) tblDepartment.getValueAt(row, 2).toString());
//        txtLocId.setText((String) tblDepartment.getValueAt(row, 3).toString());
...
//        boolean pat1 = Pattern.matches("[a-zA-Z][0-9]", key);
//        JOptionPane.showMessageDialog(this, departmentController.search(key));
    ...
    private void txtIdKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdKeyTyped
        // TODO add your handling code here:
        filterAngka(evt);
//        new Setting().checckNumber(evt, labelID);
